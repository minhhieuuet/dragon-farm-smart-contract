...
import "../core/erc721/DragonFarmBase.sol";
contract DragonFarmClockAuction is Pausable {
  constructor(uint256 _ownerCut) {
    require(_ownerCut <= 10000);
    ownerCut = _ownerCut;
  }
  
  //Auction of DragonFarm marketplace
  ...
  //Address of NFT contract => 1 => Auction1
  ///                          2 => Auction2           
  ///                          3 => Auction3


  //Fallback function - dont get money from user
